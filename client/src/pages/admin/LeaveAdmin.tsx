                  ...
                  <tr key={req.id} className="hover:bg-slate-50/80 transition-colors">
                    ...
                    <td className="py-3.5 px-4">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg bg-blue-50 text-blue-800 font-bold hover:bg-blue-100 transition-colors"
                      >
                        Review Application
                      </button>
                    </td>
          ...
          <div className="space-y-4 pt-2 text-xs text-slate-800">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3.5 py-2 bg-slate-50 border border-slate-200 rounded-xl text-xs text-slate-800 focus:ring-2 focus:ring-blue-800 focus:outline-none"
              />
            </div>
